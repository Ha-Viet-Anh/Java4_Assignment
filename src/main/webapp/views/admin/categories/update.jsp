...
<div class="container card">
	<div class="row offset-2 mt-3">
		<h2 class="form-title text-success">Quản lý danh mục (Update)</h2>
		<!-- form -->
		<form method="POST" class="col-6"
			action="/PH14045_HaVietAnh_Assignment/admin/category/update?id=${cate.id}">
			...
			</svg> Tên danh mục: ${cate.ten}</label> 
			</div>
			<div class="mt-3">
				<label>Tên mới:</label>
			...
			<div class="mt-3 mb-3">
				...
				<a class="btn btn-primary" href="/PH14045_HaVietAnh_Assignment/admin/category/create">Back</a>
			</div>
		</form>
